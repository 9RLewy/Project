...
class Brain:
    def __init__(self, num_states, num_actions):
        ...
        self.optimizer = optim.Adam(
            self.model.parameters(), lr=0.0068)
        #0.005  0.0062  50_888: 0.0068 50_1200: 0.0058 100_1200:0.0028 200_1200: 0.0008 
